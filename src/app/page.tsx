...
import { Thermometer, Wind, Droplets, Flame, Mountain, Tornado, MapPin, CloudRain, AlertTriangle, Map, Rss, Snowflake } from "lucide-react";
    ...
    <ul className="flex flex-col mt-1">
      {alertas.slice(0, 4).map((evento) => { 
        ...
        if (tituloCategoria === "Wildfires") { 
          ...
          Icone = Mountain; corIcone = "text-red-500"; bgIcone = "bg-red-50"; tituloTraduzido = "Vulcão"; 
        } else if (tituloCategoria === "Severe Storms") { 
          Icone = Tornado; corIcone = "text-blue-500"; bgIcone = "bg-blue-50"; tituloTraduzido = "Tempestade Severa"; 
        } else if (tituloCategoria === "Sea and Lake Ice") {
          Icone = Snowflake; corIcone = "text-sky-500"; bgIcone = "bg-sky-50"; tituloTraduzido = "Gelo no Mar/Lago";
        }
                ...
                <div className="flex flex-col gap-6 h-full justify-between">
                  ...
                  {dadosPrevisao && dadosPrevisao.length > 0 && (
                    <div className="mt-2 pt-4 border-t border-slate-50">
                      <h3 className="text-[12px] font-bold text-slate-400 mb-3 uppercase tracking-wider">
                        Próximos 5 dias
                      </h3>
